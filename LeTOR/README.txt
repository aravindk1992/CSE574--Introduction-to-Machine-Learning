...
To view the results, run the project1.m file which imports the project1_data.mat file and the respective functions being train_cfs, test_cfs for the closed form solution method and train_gd, test_gd for the gradient decent method.
